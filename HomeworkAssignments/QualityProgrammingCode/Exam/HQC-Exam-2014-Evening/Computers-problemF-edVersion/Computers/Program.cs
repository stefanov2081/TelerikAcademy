...
using CentralProccesingUnit;
using RandomAccessibleMemory;
using ClientSide;
using HardDisk;
using LaptopComputer;
using LaptopBattery;
using PesronalComputer;
...
#warning "This code sucks"
        ...
        class Computer
        {
            ...
            CentralProccesingUnit Cpu { get; set; }
            readonly LaptopBattery battery;
            RandomAccessibleMemory Ram { get; set; }
            ...
            internal Computer(Computers.Type type,
                CentralProccesingUnit cpu,

                RandomAccessibleMemory
                ram,
