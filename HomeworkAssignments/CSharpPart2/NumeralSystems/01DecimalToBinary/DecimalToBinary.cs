...
namespace _01DecimalToBinary
{
    class DecimalToBinary
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Signed Magnitude. The left most bit - Most Significant Bit," +
                "\nrepresents the sign. 0 for positive numbers, 1 for negative");

            // Call ToBinary() and print
            Console.WriteLine(ToBinary(n));
            Console.WriteLine("Ones Complement. Most Significant Bit represent the sign." +
                "\nAll other bits are reversed.");

            // Call OnesComplement() with the result from ToBinary() and print
            Console.WriteLine(OnesComplement(ToBinary(n)));
            Console.WriteLine("Twos Complement. Ones Complement + 1");

            // Call TwosComplement() with the resul from OnesComplement() and print
